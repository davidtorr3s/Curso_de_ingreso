...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        numer_one = self.txt_operador_a.get()
        numer_one = int(numer_one)
        
        numer_two = self.txt_operador_b.get()
        numer_two = int(numer_two)
        
        resultado = numer_one + numer_two
    ...
    def btn_restar_on_click(self):
        number_one = self.txt_operador_a.get()
        number_one = int(number_one)
        
        number_two = self.txt_operador_b.get()
        number_two = int(number_two)
        
        resultado = number_one - number_two
        
        texto = f"El resultado de la resta es: {resultado}"
    ...
    def btn_multiplicar_on_click(self):
        ...
        texto = f"El resultado de la multiplicación es: {resultado}"
    ...
    def btn_dividir_on_click(self):
        ...
        texto = f"El resultado de la división es: {resultado}"
