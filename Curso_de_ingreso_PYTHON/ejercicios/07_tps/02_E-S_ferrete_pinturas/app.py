...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        texto = f"La temperatura es de {resultado} °F"
        
        alert (title= "Farenheit", message=texto)
    ...
    def btn_convertir_f_c_on_click(self):
        ...
        texto = f"La temperatura es de {resultado} °C"
        
        alert (title= "Centigrados", message=texto)
